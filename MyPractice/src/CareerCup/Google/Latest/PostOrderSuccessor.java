...
public class PostOrderSuccessor {
	...
	public static TreeNode portOrderSucc(TreeNode root, int v) throws Exception {
		
		if (root.data == v) {
			throw new Exception("This is the root node and hence does not have any element after it.");
		}
	...
	public static void main(String[] args) throws Exception {
		...
		TreeNode postordersucc = PostOrderSuccessor.portOrderSucc(root, 20);
